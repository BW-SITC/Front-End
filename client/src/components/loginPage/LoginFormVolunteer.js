...
import { Heading, Description, Label, ButtonDiv } from "../styling/styled";
...
const FormikLoginForm = withFormik({
  ...
  handleSubmit(values, { setSubmitting }) {
    console.log(
      "VolunteerLoginForm.js -> %cname:",
      "color: purple",
      values.username
    );
    console.log(
      "VolunteerLoginForm.js -> %cpassword:",
      "color: green",
      values.password
    );
    ...
    AxiosWithAuth()
      ...
      .then(res => {
              console.log('Rez:',res);   // Data was created successfully and logs to console
              localStorage.setItem("token", res.data.token);

              // volunteers.history.push('/protected');
              setSubmitting(false);
